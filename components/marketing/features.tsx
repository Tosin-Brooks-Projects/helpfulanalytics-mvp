                    ...
                    {features.map((feature, index) => (
                        ...
                        >
                            <motion.div
                                ...
                                whileHover={{ y: -5 }}
                                className="relative overflow-hidden rounded-3xl bg-secondary/50 p-8 ring-1 ring-inset ring-foreground/10 hover:bg-secondary/80 transition-colors h-full"
                            >
