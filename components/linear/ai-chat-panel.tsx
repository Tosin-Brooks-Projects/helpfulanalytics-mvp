...
import { X, Send, RotateCcw, ChevronDown, Sparkles, Globe, Smartphone, FileText, MapPin, Radio, BarChart3 } from "lucide-react"
...
export function AIChatPanel() {
    ...
    // Derive a status label for the typing indicator
    const statusLabel = (() => {
...
function MessageContent({ msg }: { msg: any }) {
    // Try rendering from parts first (v6 UIMessage format)
    ...
    // Empty assistant message = still loading
