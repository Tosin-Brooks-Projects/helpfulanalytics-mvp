    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Simple analytics for your website. Connect your Google Analytics to get started.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <p className="text-xs text-gray-500 text-center">
            We only request read-only access to your Google Analytics data. Your data stays secure and private.
          </p>
        </CardContent>
      </Card>
    </div>
